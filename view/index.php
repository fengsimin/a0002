...
<head>
	...
	<script src="<?php echo $this->url('asset/js/cookie.js');?>"></script>
...
<body>
	...
	<div class="container">
	    ...
	    <div class="guide-bg animated" style="background-image:url(<?php echo $this->url('data/'.$site['guide_bg']);?>);">
	        <a href="javascript:;" class="arrow-down"><img src="<?php echo $this->url('asset/img/arrow-down.png');?>"></a>
	    </div>
